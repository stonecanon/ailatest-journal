...
(() => {
  ...
  const I18N = {
    zh: {
      ...
      filter_cstpcd: '科技核心',
      filter_zone_1: '1区', filter_zone_2: '2区', filter_zone_3: '3区', filter_zone_4: '4区',
      filter_warning_cas: '中科院预警', filter_warning_citic: '中信所预警',
      ...
      nav_about: '关于', nav_contact: '联系', nav_footprint: '发表足迹', rail_footprint: '足迹',
      ...
      home_rank_risk_cas: '中科院预警', home_rank_risk_citic: '中信所预警', home_rank_risk_xr: '新锐审查中',
      ...
      home_footprint_promo: '新功能：用 Google Scholar 识别你的发表足迹，生成期刊徽章墙 →',
    ...
    en: {
      ...
      filter_cstpcd: 'CSTPCD',
      filter_zone_1: '1', filter_zone_2: '2', filter_zone_3: '3', filter_zone_4: '4',
      filter_warning_cas: 'CAS warning', filter_warning_citic: 'CITIC warning',
      ...
      src_cscd: 'CSCD Journals',
      src_cstpcd: 'Chinese Science and Technology Core Journals',
      src_zju: 'ZJU 2024',
      ...
      nav_about: 'About', nav_contact: 'Contact', nav_footprint: 'Publication footprint', rail_footprint: 'Footprint',
      ...
      home_rank_all: 'All →',
      home_rank_pill_board: 'Board',
      home_rank_risk_cas: 'CAS warning list', home_rank_risk_citic: 'CITIC warning list', home_rank_risk_xr: 'Emerging Under Review',
      ...
      home_footprint_promo: 'New: identify your publications from Google Scholar and build your journal footprint →',
